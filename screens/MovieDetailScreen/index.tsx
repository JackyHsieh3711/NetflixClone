            ...
            <FlatList 
                ...
                renderItem={({item}) => (
                    <EpisodeItem 
                        episode={item} 
                        onPress={
                            (episode) => {setCurrentEpisode(episode)}
                        } 
                    />
                )}
                ...
                <View style={{padding: 12}}>
                    ...
                    {/* Play Button */}
                    <Pressable onPress={()=>{ console.log('Plage')}} style={styles.playButton} >
                    ...
                    {/* Download Button */}
                    <Pressable onPress={()=>{ console.log('Plage')}} style={styles.downloadButton} >
